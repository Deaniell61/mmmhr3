    ...
    if($resultado = $mysql->query($sql))
    {
        ...
        else
        {
            ...
            while($fila = $resultado->fetch_row())
            {
				...
				{
                $tabla .="<a class='waves-effect waves-light btn red lighten-1 modal-trigger botonesm ' onclick=\"eliminar('".$fila["4"]."')\"><i class='material-icons left'><img class='iconoeditcrud' src='../app/img/boton-borrar.png' /></i></a>";
